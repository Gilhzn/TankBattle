...
export const CATALOG: CatalogItem[] = [
  ...
  { sku: 'starter_pack', kind: 'bundle', name: 'Starter Pack', description: '300 gems, Ember skin and 3 overshields', icon: '🎁', prices: { usd: 299 }, grants: { gems: 300, items: { skin_ember: 1, boost_shield: 3 } }, oneTime: true, tag: 'new' },
  { sku: 'boost_life', kind: 'boost', name: 'Reserve Hull', description: '+1 life at match start', icon: '🛠️', prices: { coins: 250, gems: 25 }, maxPerMatch: 1, atStart: true, effect: 'life' },
  { sku: 'boost_shield', kind: 'boost', name: 'Launch Overshield', description: '10 s of invulnerability at match start', icon: '🛡️', prices: { coins: 150, gems: 15 }, maxPerMatch: 1, atStart: true, effect: 'shield' },
  { sku: 'boost_star', kind: 'boost', name: 'Hardpoint Start', description: 'Begin with a tier-1 cannon', icon: '🔺', prices: { coins: 200, gems: 20 }, maxPerMatch: 1, atStart: true, effect: 'star' },
  { sku: 'boost_grenade', kind: 'boost', name: 'Pulse Charge', description: 'Wipe all enemies on screen (use in match)', icon: '🌀', prices: { coins: 300, gems: 30 }, maxPerMatch: 2, effect: 'grenade' },
  { sku: 'boost_clock', kind: 'boost', name: 'Stasis Field', description: 'Freeze enemies for 10 s (use in match)', icon: '❄️', prices: { coins: 250, gems: 25 }, maxPerMatch: 1, effect: 'clock' },
  { sku: 'revive_token', kind: 'boost', name: 'Rebuild Token', description: 'Continue once after losing all lives', icon: '💠', prices: { gems: 50 }, maxPerMatch: 1, effect: 'revive' },
